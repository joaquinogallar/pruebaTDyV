...
import exception.NoExisteSocioException;
import exception.YaExisteSocioException;

import java.util.ArrayList;

public class NominaSocios {
	public static ArrayList<Socio> nomina;
	static int cupo;
	static int proxSocio;
	/***
	 *
	 * @param p entity.Persona a asociar. Si la persona ya existe,  no se efectiviza el alta y se lanza una excepcion
	 * @author oscar
	 * */
 ...
 * @param p entity.Persona a buscar
 */
 ...
 * @param s entity.Socio a dar de baja
